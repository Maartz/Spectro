...
final class QueryTests: XCTestCase {
    ...
    func testQueryWhereClause() {
        ...
        XCTAssertEqual(query.conditions.first, "age > 18", "The condition should be 'age > 18'")
        ...
        XCTAssertEqual(queryWithMultipleConditions.conditions[1], "is_active = true", "The second condition should be 'is_active = true'")
    }
